...
{
    GCNFIELDFLAG_READ = 1,
    GCNFIELDFLAG_WRITE = 2,
    GCNFIELDFLAG_READ_WRITE = 3,
    GCNFIELDFLAG_VGPR = 4,
    GCNFIELDFLAG_SGPR = 8,
    GCNFIELDFLAG_GPR = 12
};
...
{
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SSRC0 = 0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SSRC1
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_SGPR, // GCNFIELD_SDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SMRD_SBASE
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_SGPR, // GCNFIELD_SMRD_SDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SMRD_SOFFSET
    GCNFIELDFLAG_READ | GCNFIELDFLAG_GPR, // GCNFIELD_VOP_SRC0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_VOP_VSRC1
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_VGPR, // GCNFIELD_VOP_VDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_GPR, // GCNFIELD_VOP3_SRC0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_GPR, // GCNFIELD_VOP3_SRC1
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_GPR, // GCNFIELD_VOP3_VDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_VOP3_SSRC
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_SGPR, // GCNFIELD_VOP3_SDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_VINTRP_VSRC0
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_VGPR, // GCNFIELD_VINTRP_VDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_DS_ADDR
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_DS_DATA0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_DS_DATA1
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_VGPR, // GCNFIELD_DS_VDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_M_VADDR
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_M_VDATA
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_M_SRSRC
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_MIMG_SSAMP
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_M_SOFFSET
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_EXP_VSRC0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_EXP_VSRC1
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_EXP_VSRC2
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_EXP_VSRC3
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_FLAT_ADDR
    GCNFIELDFLAG_READ | GCNFIELDFLAG_VGPR, // GCNFIELD_FLAT_DATA
    GCNFIELDFLAG_WRITE | GCNFIELDFLAG_VGPR, // GCNFIELD_FLAT_VDST
    GCNFIELDFLAG_READ | GCNFIELDFLAG_GPR, // GCNFIELD_DPPSDWA_SRC0
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SMEM_SBASE
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR, // GCNFIELD_SMEM_SDATA
    GCNFIELDFLAG_READ | GCNFIELDFLAG_SGPR // GCNFIELD_SMEM_OFFSET
};
                 ...
                 AsmRegField regField, bool required)
{
    ...
    if (regVarFound)
    {
            ...
            ((flags & INSTROP_SREGS)!=0 && regVar->type==REGTYPE_SGPR))
        {
            ...
            const bool read = (regField!=ASMFIELD_NONE) ? 
                (gcnPlaceInfoTbl[regField] & GCNFIELDFLAG_READ) != 0 : false;
            const bool write = (regField!=ASMFIELD_NONE) ? 
                (gcnPlaceInfoTbl[regField] & GCNFIELDFLAG_WRITE) != 0 : false;
