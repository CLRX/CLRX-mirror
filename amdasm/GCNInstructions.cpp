...
const GCNInstruction CLRX::gcnInstrsTable[] =
{
    ...
    { "s_flbit_i32_b64",     GCNENC_SOP1,   GCN_REG_SRC0_64,          22,   ARCH_GCN_ALL  },
    { "s_flbit_i32",         GCNENC_SOP1,   GCN_STDMODE,              23,   ARCH_GCN_ALL  },
    { "s_flbit_i32_i64",     GCNENC_SOP1,   GCN_REG_SRC0_64,          24,   ARCH_GCN_ALL  },
    { "s_sext_i32_i8",       GCNENC_SOP1,   GCN_STDMODE,              25,   ARCH_GCN_ALL  },
    { "s_sext_i32_i16",      GCNENC_SOP1,   GCN_STDMODE,              26,   ARCH_GCN_ALL  },
    ...
    { "s_getpc_b64",         GCNENC_SOP1,   GCN_REG_ALL_64|GCN_SRC_NONE, 31,   ARCH_GCN_ALL  },
    { "s_setpc_b64",         GCNENC_SOP1,   GCN_REG_ALL_64|GCN_DST_NONE, 32,   ARCH_GCN_ALL  },
    { "s_swappc_b64",        GCNENC_SOP1,   GCN_REG_ALL_64,           33,   ARCH_GCN_ALL  },
    { "s_rfe_b64",           GCNENC_SOP1,   GCN_REG_ALL_64|GCN_DST_NONE, 34,   ARCH_GCN_ALL  },
    ...
    { "s_orn2_saveexec_b64", GCNENC_SOP1,   GCN_REG_ALL_64,           40,   ARCH_GCN_ALL  },
    ...
    { "s_cbranch_join",      GCNENC_SOP1,   GCN_STDMODE|GCN_DST_NONE, 50,   ARCH_GCN_ALL  },
    { "s_mov_regrd_b32",     GCNENC_SOP1,   GCN_STDMODE,              51,   ARCH_GCN_ALL  },
    { "s_abs_i32",           GCNENC_SOP1,   GCN_STDMODE,              52,   ARCH_GCN_ALL  },
    { "s_mov_fed_b32",       GCNENC_SOP1,   GCN_STDMODE, /* check for GCN1.1 !*/  53,   ARCH_GCN_ALL  },
    ...
    { "v_readlane_b32",      GCNENC_VOP2,   GCN_DS1_SGPR,             1,    ARCH_GCN_ALL  },
    { "v_readlane_b32",      GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12|GCN_VOP3_DS1_SGPR,
        257,  ARCH_GCN_ALL  },
    { "v_writelane_b32",     GCNENC_VOP2,   GCN_SRC1_SGPR,            2,    ARCH_GCN_ALL  },
    { "v_writelane_b32",     GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12|GCN_VOP3_SRC1_SGPR,
        258,  ARCH_GCN_ALL  },
    { "v_add_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             3,    ARCH_GCN_ALL  },
    { "v_add_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       259,  ARCH_GCN_ALL  },
    { "v_sub_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             4,    ARCH_GCN_ALL  },
    { "v_sub_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       260,  ARCH_GCN_ALL  },
    { "v_subrev_f32",        GCNENC_VOP2,   GCN_FLOATLIT,             5,    ARCH_GCN_ALL  },
    { "v_subrev_f32",        GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       261,  ARCH_GCN_ALL  },
    { "v_mac_legacy_f32",    GCNENC_VOP2,   GCN_FLOATLIT,             6,    ARCH_GCN_ALL  },
    { "v_mac_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       262,  ARCH_GCN_ALL  },
    { "v_mul_legacy_f32",    GCNENC_VOP2,   GCN_FLOATLIT,             7,    ARCH_GCN_ALL  },
    { "v_mul_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       263,  ARCH_GCN_ALL  },
    { "v_mul_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             8,    ARCH_GCN_ALL  },
    { "v_mul_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       264,  ARCH_GCN_ALL  },
    { "v_mul_i32_i24",       GCNENC_VOP2,   GCN_STDMODE,              9,    ARCH_GCN_ALL  },
    { "v_mul_i32_i24",       GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       265,  ARCH_GCN_ALL  },
    { "v_mul_hi_i32_i24",    GCNENC_VOP2,   GCN_STDMODE,              10,   ARCH_GCN_ALL  },
    { "v_mul_hi_i32_i24",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       266,  ARCH_GCN_ALL  },
    { "v_mul_u32_u24",       GCNENC_VOP2,   GCN_STDMODE,              11,   ARCH_GCN_ALL  },
    { "v_mul_u32_u24",       GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       267,  ARCH_GCN_ALL  },
    { "v_mul_hi_u32_u24",    GCNENC_VOP2,   GCN_STDMODE,              12,   ARCH_GCN_ALL  },
    { "v_mul_hi_u32_u24",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       268,  ARCH_GCN_ALL  },
    { "v_min_legacy_f32",    GCNENC_VOP2,   GCN_FLOATLIT,             13,   ARCH_GCN_ALL  },
    { "v_min_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       269,  ARCH_GCN_ALL  },
    { "v_max_legacy_f32",    GCNENC_VOP2,   GCN_FLOATLIT,             14,   ARCH_GCN_ALL  },
    { "v_max_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       270,  ARCH_GCN_ALL  },
    { "v_min_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             15,   ARCH_GCN_ALL  },
    { "v_min_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       271,  ARCH_GCN_ALL  },
    { "v_max_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             16,   ARCH_GCN_ALL  },
    { "v_max_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       272,  ARCH_GCN_ALL  },
    { "v_min_i32",           GCNENC_VOP2,   GCN_STDMODE,              17,   ARCH_GCN_ALL  },
    { "v_min_i32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       273,  ARCH_GCN_ALL  },
    { "v_max_i32",           GCNENC_VOP2,   GCN_STDMODE,              18,   ARCH_GCN_ALL  },
    { "v_max_i32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       274,  ARCH_GCN_ALL  },
    { "v_min_u32",           GCNENC_VOP2,   GCN_STDMODE,              19,   ARCH_GCN_ALL  },
    { "v_min_u32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       275,  ARCH_GCN_ALL  },
    { "v_max_u32",           GCNENC_VOP2,   GCN_STDMODE,              20,   ARCH_GCN_ALL  },
    { "v_max_u32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       276,  ARCH_GCN_ALL  },
    { "v_lshr_b32",          GCNENC_VOP2,   GCN_STDMODE,              21,   ARCH_GCN_ALL  },
    { "v_lshr_b32",          GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       277,  ARCH_GCN_ALL  },
    { "v_lshrrev_b32",       GCNENC_VOP2,   GCN_STDMODE,              22,   ARCH_GCN_ALL  },
    { "v_lshrrev_b32",       GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       278,  ARCH_GCN_ALL  },
    { "v_ashr_i32",          GCNENC_VOP2,   GCN_STDMODE,              23,   ARCH_GCN_ALL  },
    { "v_ashr_i32",          GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       279,  ARCH_GCN_ALL  },
    { "v_ashrrev_i32",       GCNENC_VOP2,   GCN_STDMODE,              24,   ARCH_GCN_ALL  },
    { "v_ashrrev_i32",       GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       280,  ARCH_GCN_ALL  },
    { "v_lshl_b32",          GCNENC_VOP2,   GCN_STDMODE,              25,   ARCH_GCN_ALL  },
    { "v_lshl_b32",          GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       281,  ARCH_GCN_ALL  },
    { "v_lshlrev_b32",       GCNENC_VOP2,   GCN_STDMODE,              26,   ARCH_GCN_ALL  },
    { "v_lshlrev_b32",       GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       282,  ARCH_GCN_ALL  },
    { "v_and_b32",           GCNENC_VOP2,   GCN_STDMODE,              27,   ARCH_GCN_ALL  },
    { "v_and_b32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       283,  ARCH_GCN_ALL  },
    { "v_or_b32",            GCNENC_VOP2,   GCN_STDMODE,              28,   ARCH_GCN_ALL  },
    { "v_or_b32",            GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       284,  ARCH_GCN_ALL  },
    { "v_xor_b32",           GCNENC_VOP2,   GCN_STDMODE,              29,   ARCH_GCN_ALL  },
    { "v_xor_b32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       285,  ARCH_GCN_ALL  },
    { "v_bfm_b32",           GCNENC_VOP2,   GCN_STDMODE,              30,   ARCH_GCN_ALL  },
    { "v_bfm_b32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       286,  ARCH_GCN_ALL  },
    { "v_mac_f32",           GCNENC_VOP2,   GCN_FLOATLIT,             31,   ARCH_GCN_ALL  },
    { "v_mac_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       287,  ARCH_GCN_ALL  },
    { "v_madmk_f32",         GCNENC_VOP2,   GCN_FLOATLIT|GCN_ARG1_IMM,32,   ARCH_GCN_ALL  },
    { "v_madmk_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP2|GCN_ARG1_IMM, 288,  ARCH_GCN_ALL  },
    { "v_madak_f32",         GCNENC_VOP2,   GCN_FLOATLIT|GCN_ARG2_IMM,33,   ARCH_GCN_ALL  },
    { "v_madak_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP2|GCN_ARG2_IMM, 289,  ARCH_GCN_ALL  },
    { "v_bcnt_u32_b32",      GCNENC_VOP2,   GCN_STDMODE,              34,   ARCH_GCN_ALL  },
    { "v_bcnt_u32_b32",      GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       290,  ARCH_GCN_ALL  },
    { "v_mbcnt_lo_u32_b32",  GCNENC_VOP2,   GCN_STDMODE,              35,   ARCH_GCN_ALL  },
    { "v_mbcnt_lo_u32_b32",  GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       291,  ARCH_GCN_ALL  },
    { "v_mbcnt_hi_u32_b32",  GCNENC_VOP2,   GCN_STDMODE,              36,   ARCH_GCN_ALL  },
    { "v_mbcnt_hi_u32_b32",  GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       292,  ARCH_GCN_ALL  },
    { "v_add_i32",           GCNENC_VOP2,   GCN_DST_VCC,              37,   ARCH_GCN_ALL  },
    { "v_add_i32",           GCNENC_VOP3B,  GCN_DST_VCC|GCN_VOP3_VOP2, 293,  ARCH_GCN_ALL  },
    { "v_sub_i32",           GCNENC_VOP2,   GCN_DST_VCC,              38,   ARCH_GCN_ALL  },
    { "v_sub_i32",           GCNENC_VOP3B,  GCN_DST_VCC|GCN_VOP3_VOP2, 294,  ARCH_GCN_ALL  },
    { "v_subrev_i32",        GCNENC_VOP2,   GCN_DST_VCC,              39,   ARCH_GCN_ALL  },
    { "v_subrev_i32",        GCNENC_VOP3B,  GCN_DST_VCC|GCN_VOP3_VOP2, 295,  ARCH_GCN_ALL  },
    { "v_addc_u32",          GCNENC_VOP2,   GCN_DS2_VCC,              40,   ARCH_GCN_ALL  },
    { "v_addc_u32",          GCNENC_VOP3B,  GCN_DS2_VCC|GCN_VOP3_VOP2, 296,  ARCH_GCN_ALL  },
    { "v_subb_u32",          GCNENC_VOP2,   GCN_DS2_VCC,              41,   ARCH_GCN_ALL  },
    { "v_subb_u32",          GCNENC_VOP3B,  GCN_DS2_VCC|GCN_VOP3_VOP2, 297,  ARCH_GCN_ALL  },
    { "v_subbrev_u32",       GCNENC_VOP2,   GCN_DS2_VCC,              42,   ARCH_GCN_ALL  },
    { "v_subbrev_u32",       GCNENC_VOP3B,  GCN_DS2_VCC| GCN_VOP3_VOP2, 298,  ARCH_GCN_ALL  },
    { "v_ldexp_f32",         GCNENC_VOP2,   GCN_FLOATLIT,             43,   ARCH_GCN_ALL  },
    { "v_ldexp_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       299,  ARCH_GCN_ALL  },
    { "v_cvt_pkaccum_u8_f32",GCNENC_VOP2,   GCN_FLOATLIT,             44,   ARCH_GCN_ALL  },
    { "v_cvt_pkaccum_u8_f32",GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       300,  ARCH_GCN_ALL  },
    { "v_cvt_pknorm_i16_f32",GCNENC_VOP2,   GCN_FLOATLIT,             45,   ARCH_GCN_ALL  },
    { "v_cvt_pknorm_i16_f32",GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       301,  ARCH_GCN_ALL  },
    { "v_cvt_pknorm_u16_f32",GCNENC_VOP2,   GCN_FLOATLIT,             46,   ARCH_GCN_ALL  },
    { "v_cvt_pknorm_u16_f32",GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       302,  ARCH_GCN_ALL  },
    { "v_cvt_pkrtz_f16_f32", GCNENC_VOP2,   GCN_FLOATLIT,             47,   ARCH_GCN_ALL  },
    { "v_cvt_pkrtz_f16_f32", GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       303,  ARCH_GCN_ALL  },
    { "v_cvt_pk_u16_u32",    GCNENC_VOP2,   GCN_STDMODE,              48,   ARCH_GCN_ALL  },
    { "v_cvt_pk_u16_u32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       304,  ARCH_GCN_ALL  },
    { "v_cvt_pk_i16_i32",    GCNENC_VOP2,   GCN_STDMODE,              49,   ARCH_GCN_ALL  },
    { "v_cvt_pk_i16_i32",    GCNENC_VOP3A,  GCN_VOP3_VOP2_DS12,       305,  ARCH_GCN_ALL  },
    ...
    { "v_fract_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 416,  ARCH_GCN_ALL  },
    { "v_trunc_f32",         GCNENC_VOP1,   GCN_FLOATLIT,             33,   ARCH_GCN_ALL  },
    { "v_trunc_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 417,  ARCH_GCN_ALL  },
    { "v_ceil_f32",          GCNENC_VOP1,   GCN_FLOATLIT,             34,   ARCH_GCN_ALL  },
    { "v_ceil_f32",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 418,  ARCH_GCN_ALL  },
    { "v_rndne_f32",         GCNENC_VOP1,   GCN_FLOATLIT,             35,   ARCH_GCN_ALL  },
    { "v_rndne_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 419,  ARCH_GCN_ALL  },
    { "v_floor_f32",         GCNENC_VOP1,   GCN_FLOATLIT,             36,   ARCH_GCN_ALL  },
    { "v_floor_f32",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 420,  ARCH_GCN_ALL  },
    { "v_exp_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             37,   ARCH_GCN_ALL  },
    { "v_exp_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 421,  ARCH_GCN_ALL  },
    { "v_log_clamp_f32",     GCNENC_VOP1,   GCN_FLOATLIT,             38,   ARCH_GCN_ALL  },
    { "v_log_clamp_f32",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 422,  ARCH_GCN_ALL  },
    { "v_log_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             39,   ARCH_GCN_ALL  },
    { "v_log_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 423,  ARCH_GCN_ALL  },
    { "v_rcp_clamp_f32",     GCNENC_VOP1,   GCN_FLOATLIT,             40,   ARCH_GCN_ALL  },
    { "v_rcp_clamp_f32",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 424,  ARCH_GCN_ALL  },
    { "v_rcp_legacy_f32",    GCNENC_VOP1,   GCN_FLOATLIT,             41,   ARCH_GCN_ALL  },
    { "v_rcp_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 425,  ARCH_GCN_ALL  },
    { "v_rcp_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             42,   ARCH_GCN_ALL  },
    { "v_rcp_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 426,  ARCH_GCN_ALL  },
    { "v_rcp_iflag_f32",     GCNENC_VOP1,   GCN_FLOATLIT,             43,   ARCH_GCN_ALL  },
    { "v_rcp_iflag_f32",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 427,  ARCH_GCN_ALL  },
    { "v_rsq_clamp_f32",     GCNENC_VOP1,   GCN_FLOATLIT,             44,   ARCH_GCN_ALL  },
    { "v_rsq_clamp_f32",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 428,  ARCH_GCN_ALL  },
    { "v_rsq_legacy_f32",    GCNENC_VOP1,   GCN_FLOATLIT,             45,   ARCH_GCN_ALL  },
    { "v_rsq_legacy_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 429,  ARCH_GCN_ALL  },
    { "v_rsq_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             46,   ARCH_GCN_ALL  },
    { "v_rsq_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1, 430,  ARCH_GCN_ALL  },
    { "v_rcp_f64",           GCNENC_VOP1,   GCN_REG_DS0_64,           47,   ARCH_GCN_ALL  },
    { "v_rcp_f64",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,431,  ARCH_GCN_ALL  },
    { "v_rcp_clamp_f64",     GCNENC_VOP1,   GCN_REG_DS0_64,           48,   ARCH_GCN_ALL  },
    { "v_rcp_clamp_f64",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,432,  ARCH_GCN_ALL  },
    { "v_rsq_f64",           GCNENC_VOP1,   GCN_REG_DS0_64,           49,   ARCH_GCN_ALL  },
    { "v_rsq_f64",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,433,  ARCH_GCN_ALL  },
    { "v_rsq_clamp_f64",     GCNENC_VOP1,   GCN_REG_DS0_64,           50,   ARCH_GCN_ALL  },
    { "v_rsq_clamp_f64",     GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,434,  ARCH_GCN_ALL  },
    { "v_sqrt_f32",          GCNENC_VOP1,   GCN_FLOATLIT,             51,   ARCH_GCN_ALL  },
    { "v_sqrt_f32",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           435,  ARCH_GCN_ALL  },
    { "v_sqrt_f64",          GCNENC_VOP1,   GCN_REG_DS0_64,           52,   ARCH_GCN_ALL  },
    { "v_sqrt_f64",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,436,  ARCH_GCN_ALL  },
    { "v_sin_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             53,   ARCH_GCN_ALL  },
    { "v_sin_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           437,  ARCH_GCN_ALL  },
    { "v_cos_f32",           GCNENC_VOP1,   GCN_FLOATLIT,             54,   ARCH_GCN_ALL  },
    { "v_cos_f32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           438,  ARCH_GCN_ALL  },
    { "v_not_b32",           GCNENC_VOP1,   GCN_STDMODE,              55,   ARCH_GCN_ALL  },
    { "v_not_b32",           GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           439,  ARCH_GCN_ALL  },
    { "v_bfrev_b32",         GCNENC_VOP1,   GCN_STDMODE,              56,   ARCH_GCN_ALL  },
    { "v_bfrev_b32",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           440,  ARCH_GCN_ALL  },
    { "v_ffbh_u32",          GCNENC_VOP1,   GCN_STDMODE,              57,   ARCH_GCN_ALL  },
    { "v_ffbh_u32",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           441,  ARCH_GCN_ALL  },
    { "v_ffbl_b32",          GCNENC_VOP1,   GCN_STDMODE,              58,   ARCH_GCN_ALL  },
    { "v_ffbl_b32",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           442,  ARCH_GCN_ALL  },
    { "v_ffbh_i32",          GCNENC_VOP1,   GCN_STDMODE,              59,   ARCH_GCN_ALL  },
    { "v_ffbh_i32",          GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           443,  ARCH_GCN_ALL  },
    { "v_frexp_exp_i32_f64", GCNENC_VOP1,   GCN_REG_SRC0_64,          60,   ARCH_GCN_ALL  },
    { "v_frexp_exp_i32_f64", GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_SRC0_64,444,  ARCH_GCN_ALL  },
    { "v_frexp_mant_f64",    GCNENC_VOP1,   GCN_REG_DS0_64,           61,   ARCH_GCN_ALL  },
    { "v_frexp_mant_f64",    GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,445,  ARCH_GCN_ALL  },
    { "v_fract_f64",         GCNENC_VOP1,   GCN_REG_DS0_64,           62,   ARCH_GCN_ALL  },
    { "v_fract_f64",         GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1|GCN_REG_DS0_64,446,  ARCH_GCN_ALL  },
    { "v_frexp_exp_i32_f32", GCNENC_VOP1,   GCN_FLOATLIT,             63,   ARCH_GCN_ALL  },
    { "v_frexp_exp_i32_f32", GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           447,  ARCH_GCN_ALL  },
    { "v_frexp_mant_f32",    GCNENC_VOP1,   GCN_FLOATLIT,             64,   ARCH_GCN_ALL  },
    { "v_frexp_mant_f32",    GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           448,  ARCH_GCN_ALL  },
    { "v_clrexcp",           GCNENC_VOP1,   GCN_VOP_ARG_NONE,         65,   ARCH_GCN_ALL  },
    { "v_clrexcp",           GCNENC_VOP3A,  GCN_VOP_ARG_NONE|GCN_VOP3_VOP1, 449,  ARCH_GCN_ALL  },
    { "v_movreld_b32",       GCNENC_VOP1,   GCN_STDMODE,              66,   ARCH_GCN_ALL  },
    { "v_movreld_b32",       GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           450,  ARCH_GCN_ALL  },
    { "v_movrels_b32",       GCNENC_VOP1,   GCN_STDMODE,              67,   ARCH_GCN_ALL  },
    { "v_movrels_b32",       GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           451,  ARCH_GCN_ALL  },
    { "v_movrelsd_b32",      GCNENC_VOP1,   GCN_STDMODE,              68,   ARCH_GCN_ALL  },
    { "v_movrelsd_b32",      GCNENC_VOP3A,  GCN_VOP3_VOP1_DS1,           452,  ARCH_GCN_ALL  },
    ...
    { "v_cubesc_f32",        GCNENC_VOP3A,  GCN_STDMODE,              325,  ARCH_GCN_ALL  },
    { "v_cubetc_f32",        GCNENC_VOP3A,  GCN_STDMODE,              326,  ARCH_GCN_ALL  },
    { "v_cubema_f32",        GCNENC_VOP3A,  GCN_STDMODE,              327,  ARCH_GCN_ALL  },
    ...
    { "v_lshl_b64",          GCNENC_VOP3A,  GCN_REG_DS0_64|GCN_SRC2_NONE,353,  ARCH_GCN_ALL  },
    { "v_lshr_b64",          GCNENC_VOP3A,  GCN_REG_DS0_64|GCN_SRC2_NONE,354,  ARCH_GCN_ALL  },
    { "v_ashr_i64",          GCNENC_VOP3A,  GCN_REG_DS0_64|GCN_SRC2_NONE,355,  ARCH_GCN_ALL  },
    ...
    { "v_ldexp_f64",         GCNENC_VOP3A,  GCN_REG_DS0_64|GCN_SRC2_NONE,360,  ARCH_GCN_ALL  },
    ...
    { "ds_swizzle_b32",      GCNENC_DS,     GCN_ADDR_SRC|GCN_NOSRC,   53,   ARCH_GCN_ALL  },
    ...
    { "ds_ordered_count",    GCNENC_DS,     GCN_ADDR_SRC|GCN_NOSRC,   63,   ARCH_GCN_ALL  },
    ...
    { "buffer_atomic_cmpswap", GCNENC_MUBUF,  GCN_MUBUF_MX2,          49,   ARCH_GCN_ALL  },
    ...
    { "buffer_atomic_fcmpswap", GCNENC_MUBUF,  GCN_MUBUF_MX2,         62,   ARCH_GCN_ALL  },
    ...
    { "buffer_atomic_cmpswap_x2", GCNENC_MUBUF,  GCN_MUBUF_MX4,       81,   ARCH_GCN_ALL  },
    ...
    { "buffer_atomic_fcmpswap_x2", GCNENC_MUBUF,  GCN_MUBUF_MX4,      94,   ARCH_GCN_ALL  },
    ...
    { "buffer_wbinvl1_sc",   GCNENC_MUBUF,  GCN_MUBUF_X|GCN_ARG_NONE, 112,  ARCH_GCN_ALL  },
    { "buffer_wbinvl1",      GCNENC_MUBUF,  GCN_MUBUF_X|GCN_ARG_NONE, 113,  ARCH_GCN_ALL  },
