...
The DST_SEL modifier determines which first part of destination dword will be placed
to choosen part with same length of this dword.
This make operation `(RESULT & PARTMASK) << PARTSHIFT`.
The SRC0_SEL and SRC1_SEL determines what part of source dword will be placed to first
