...
[--HSALayout] [--raw] [--gpuType=GPUDEVICE] [--arch=ARCH] [--driverVersion=VERSION]
...
=item clrxdisasm -aCHL -t240400 source.clo
...
=item clrxdisasm -aC -gBonaire source.clo
...
=item clrxdisasm -aC -t170000 --llvmVersion=40000 -gBonaire source.clo
