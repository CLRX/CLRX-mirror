...
This disassembler can disassemble code for GCN 1.0/1.1/1.2
...
Choose device type. This option replaces previously choosen architecture by
architecture of choosen device. Device type name is case-insensitive.
...
Choose device architecture. This options replaces previously choosen device by
first device that have choosen arhitecture. Architecture name is case-insensitive.
