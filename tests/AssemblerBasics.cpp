...
x2:
            x2_1 = 7)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 0x94, 0, 0, 0, 0xe, 0, 0, 0 } } },
        {
...
test.s:19:1: Error: Symbol 'x2' is already defined
    ...
    {   R"ffDXD(            .eqv t0, x0<<65
            ...
            .int t20)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 0, 0, 0, 0, 0, 0, 0, 0 } } },
        {
            { ".", 8U, 0, 0U, true, false, false, 0, 0 },
...
test.s:38:23: Error: Expected ',' before argument
    ...
    {   ".FILL 5,,15\n",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 15, 15, 15, 15, 15 } } },
...
.int , 2 x; ; .fill xxx,; .fill yyy)ffDXD",
    ...
    {   R"ffDXD(            .if 4
            ...
            .endif)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 4 } } },
    ...
    {   R"ffDXD(            .if 0
            ...
            .endif)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 2, 4, 9 } } },
    ...
    {   R"ffDXD(            .if 123
            ...
            .byte 22)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 1 } } },
        { { ".", 1U, 0, 0U, true, false, false, 0, 0 } },
    ...
    {   R"ffDXD(            .if 123
            ...
            .byte 10)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 0, 1 } } },
...
test.s:27:13: Error: Unterminated '.if'
    ...
    {   R"ffDXD(                .ifc ala ++ ala, ala + +  ala
                ...
                .endif)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 0x0b, 0x0e, 0x12, 0x13 } } },
    ...
    {   R"ffDXD(            .rept 1
            ...
            .endr)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 2, 2, 2 } } },
        {
            { ".", 3U, 0, 0U, true, false, false, 0, 0 },
...
In macro content:
    ...
    {   R"ffDXD(            .macro xxx
            ...
            .endm)ffDXD",
        BinaryFormat::AMD, GPUDeviceType::CAPE_VERDE, false, { },
        { { ASMKERN_GLOBAL, AsmSectionType::DATA, { 3, 4, 5 } } },
        { { ".", 3U, 0, 0U, true, false, false, 0, 0 } },
        true, "In macro substituted from test.s:6:13:\n"
